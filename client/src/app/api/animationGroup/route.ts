...
export async function GET(req: NextRequest) {
	...
	const animationCollection = db.collection(process.env.ANIMATION_GROUP_COLLECTION);
	const effectCollection = db.collection(process.env.ANIMATION_GROUP_COLLECTION);
	...
	const effects = await client
		...
		.collection<StaticAnimationBaseT>(process.env.STATIC_ANIMATION_COLLECTION)
...
export async function POST(req: NextRequest) {
	...
	const collection = client
		.db(process.env.DB_NAME)
		.collection(process.env.ANIMATION_GROUP_COLLECTION);
